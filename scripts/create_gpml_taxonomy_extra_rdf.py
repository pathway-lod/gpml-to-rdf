...
def aggregate_ttls(output_root: Path, aggregate_file: Path) -> None:
    ...
    with aggregate_file.open("w", encoding="utf-8") as out:
        for ttl_file in ttl_files:
            out.write(ttl_file.read_text(encoding="utf-8"))
            out.write("\n")
...
def main() -> None:
    ...
    parser.add_argument("--output-dir", default="extra-taxonomy")
    parser.add_argument(
        "--aggregate-file",
        default="all_gpml_taxonomy_extra-plantcyc17.0.0-gpml2021.ttl",
    )
